...
function(CHECK_CONFIG)
	if(NOT DEFINED BEAST_LIB_TARGET_NAME)
		message(FATAL_ERROR "The BEAST_LIB_TARGET_NAME is not defined!")
	endif()
	if(NOT DEFINED BEAST_EXE_TARGET_NAME)
		message(FATAL_ERROR "The BEAST_EXE_TARGET_NAME is not defined!")
	endif()
	if(NOT DEFINED BEAST_UNIT_TESTS_TARGET_NAME)
		message(FATAL_ERROR "The BEAST_UNIT_TEST_TARGET_NAME is not defined!")
	endif()
	if(NOT DEFINED BEAST_INTEGRATION_TESTS_TARGET_NAME)
		message(FATAL_ERROR "The BEAST_INTEGRATION_TEST_TARGET_NAME is not defined!")
	endif()
endfunction()
