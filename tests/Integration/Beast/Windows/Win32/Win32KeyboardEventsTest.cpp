...
namespace be::tests::integration
{
    INSTANTIATE_TEST_SUITE_P(
        ...
        testing::Values(
            ...
            WindowsKeyboardEventsTestParams{0x57, KeyCode::W},
            WindowsKeyboardEventsTestParams{0x58, KeyCode::X},
            WindowsKeyboardEventsTestParams{0x59, KeyCode::Y},
            WindowsKeyboardEventsTestParams{0x5A, KeyCode::Z},
